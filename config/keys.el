...
(global-set-key (kbd "C-z g") 'org-open-go-workshops)
...
(global-set-key (kbd "<f1>b") 'magit-blame)
...
(global-set-key (kbd "<f1>ow") 'org-open-wiki)
...
;; Global mode
;; TODO refactor all keys for use this one
